...
--set a global variable so when the game reloads, counter increases to update game level
gameStatelevel = 1
function love.draw()
    ...
    love.graphics.print('LEVEL '..tostring(gameStatelevel), VIRTUAL_WIDTH/2, VIRTUAL_HEIGHT/4)
